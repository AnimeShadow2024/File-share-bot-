...
def start_button(client):
    ...
    if not FORCE_SUB_CHANNEL and FORCE_SUB_GROUP:
        buttons = [
            [
                InlineKeyboardButton(text="🦁Gʀᴏᴜᴘ🦁", url='https://t.me/+r4jNG0UzY9diY2Vl'),
            ],
            [
    ...
    if FORCE_SUB_CHANNEL and FORCE_SUB_GROUP:
        buttons = [
            ...
            [
                InlineKeyboardButton(text="ᴄʜᴀɴɴᴇʟ 𝟷", url=client.invitelink),
                InlineKeyboardButton(text="ᴄʜᴀɴɴᴇʟ 𝟸", url='https://t.me/+r4jNG0UzY9diY2Vl'),
            ],
            [InlineKeyboardButton(text="🍁Cʟᴏsᴇ🍁", callback_data="close")],
        ]
        return buttons
...
def fsub_button(client, message):
    if not FORCE_SUB_CHANNEL and FORCE_SUB_GROUP:
        buttons = [
            [
                InlineKeyboardButton(text="ᴊᴏɪɴ ᴄʜᴀɴɴᴇʟ 𝟸", url='https://t.me/+r4jNG0UzY9diY2Vl'),
            ],
        ]
        try:
            buttons.append(
